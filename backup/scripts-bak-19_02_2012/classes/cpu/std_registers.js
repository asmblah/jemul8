...
.module("cpu/std_registers", function ( $ ) { "use strict";
	...
	jemul8.x86CPU.prototype.installStdRegisters = function () {
		var Register = jemul8.Register
			, LazyFlagRegister = jemul8.LazyFlagRegister
			, SubRegister = jemul8.SubRegister
			, SegRegister = jemul8.SegRegister
			, BitFlag = jemul8.BitFlag
			, LazyFlag = jemul8.LazyFlag
			, UnlazyFlag = jemul8.UnlazyFlag
			, Pin = jemul8.Pin;
		...
		this.hsh_regOrdinals_Segment_Mod00RM16 = [
			this.DS, this.DS, this.SS, this.SS
			, this.DS, this.DS, this.DS, this.DS
		];
		this.hsh_regOrdinals_Segment_Mod01or10RM16 = [
			this.DS, this.DS, this.SS, this.SS
