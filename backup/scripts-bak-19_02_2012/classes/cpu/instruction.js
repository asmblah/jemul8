...
.module("cpu/instruction", function ( $ ) { "use strict";
	...
	jemul8.x86CPU.prototype.hsh_fn_insnExecute = {
		...
		// Make Stack Frame ( 80188+ )
			...
			jemul8.warning("ENTER insn not tested fully");
		...
		// Signed Integer Division
			...
			cpu.hsh_fn_insnExecute.DIV.call(this, cpu);
			return;
		...
		// High Level Procedure Exit
			...
			jemul8.warning("LEAVE insn not tested fully");
		...
		// Shift Arithmetic Right ( with signed divide )
			...
			debugger;
			jemul8.problem("We don't use negative numbers any more,"
