...
.module("iodev/pit", function ( $ ) { "use strict";
	...
	function PIT( machine ) {
		jemul8.assert(this && (this instanceof PIT), "PIT ctor ::"
			+ " error - constructor not called properly");
		
		/** 8254/82C54 Programmable Interval Timer (PIT) **/
		
		jemul8.info("PIT (Intel 8254/82C54) PreInit");
		
		this.machine = machine;
		
		this.state = {
			/* PIT_82c54 */timer: new jemul8.PIT_82C54( this )
	...
	$.inherit(PIT, jemul8.IODevice, "PIT"); // Inheritance
	$.extend(PIT.prototype, {
		init: function () {
			...
			jemul8.debug(("RESETting timer."));
			state.timer_handle.deactivate();
			jemul8.debug(("deactivated timer."));
		...
		// Based on [bx_pit_c::handle_timer]
			...
			jemul8.debug(("entering timer handler"));
