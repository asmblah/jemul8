...
.module("cpu", function ( $ ) {
	...
	function x86CPU( emu, name_class ) {
		this.emu = emu;
	...
	x86CPU.prototype.install = function ( component ) {
		...
		case x86Emu.Register:	// Fall through
		case x86Emu.SubRegister:
		case x86Emu.LazyFlagRegister:
		...
		case x86Emu.Pin:
			...
			break;
		default:
			throw new Error( "x86CPU.install :: Provided component cannot be installed into the CPU." );
		}
	};
