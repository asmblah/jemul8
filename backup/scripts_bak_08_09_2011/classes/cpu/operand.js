...
.module("cpu/operand", function ( $ ) { "use strict";
	...
	/*hsh_func_operandRead_WithPointer.SEGMENT = */hsh_func_operandRead_WithPointer.GENERAL = function () {
		//var res = this.insn.machine.cpu.accessorRead.readValue((this.getSegment() << 4) + ((this.reg.get() + (this.reg2 ? this.reg2.get() : 0) + this.displacement) /* * this.insn.sizeAddress*/), this.insn.sizeOperand);
	...
	hsh_func_operandRead_WithPointer.MEM_DISPLACEMENT = function () {
		//var res = this.insn.machine.cpu.accessorRead.readValue((this.getSegment() << 4) + (this.displacement /* * this.insn.sizeAddress*/), this.insn.sizeOperand);
		var res = this.reg_segment.readSegment(
			this.displacement
			, this.insn.sizeOperand);
		return res;
	...
	hsh_func_operandWrite_WithPointer.SEGMENT = hsh_func_operandWrite_WithPointer.GENERAL = function ( val ) {
		...
		//this.insn.machine.cpu.accessorRead.writeValue((this.getSegment() << 4) + ((this.reg.get() + this.displacement) /* * this.insn.sizeAddress*/), val & this.insn.mask_sizeOperand, this.insn.sizeOperand);
	...
	hsh_func_operandWrite_WithPointer.MEM_DISPLACEMENT = function ( val ) {
		...
		//this.insn.machine.cpu.accessorRead.writeValue((this.getSegment() << 4) + (this.displacement /* * this.insn.sizeAddress*/), val & this.insn.mask_sizeOperand, this.insn.sizeOperand);
		this.reg_segment.writeSegment(
			this.displacement
			, val & this.insn.mask_sizeOperand
			, this.insn.sizeOperand);
