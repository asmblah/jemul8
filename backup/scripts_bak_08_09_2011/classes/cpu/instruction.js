	...
	jemul8.x86CPU.prototype.hsh_fn_insnExecute = {
		...
		// Load Full Pointer with DS
			...
			if ( this.sizeOperand <= 2 ) {
				...
				//cpu.DS.set(accessorRead.readValue(this.operand2.getPointerAddress() + 2, 2));
				// In Protected Mode, load the descriptor into the segment register
			// 32-bit
			} else {
				this.operand1.write(this.operand2.read());
				jemul8.panic("LDS :: Not implemented");
				//cpu.DS.set(accessorRead.readValue(this.operand2.getPointerAddress() + 4, 2));
				// In Protected Mode, load the descriptor into the segment register
			}
		// Load Full Pointer with ES
			...
			if ( this.sizeOperand <= 2 ) {
				...
				//cpu.ES.set(accessorRead.readValue(this.operand2.getPointerAddress() + 2, 2));
				// In Protected Mode, load the descriptor into the segment register
			// 32-bit
			} else {
				this.operand1.write(this.operand2.read());
				jemul8.panic("LES :: Not implemented");
				//cpu.ES.set(accessorRead.readValue(this.operand2.getPointerAddress() + 4, 2));
				// In Protected Mode, load the descriptor into the segment register
			}
		// Load Full Pointer with FS
			...
			if ( this.sizeOperand <= 2 ) {
				...
				//cpu.FS.set(accessorRead.readValue(this.operand2.getPointerAddress() + 2, 2));
				// In Protected Mode, load the descriptor into the segment register
			// 32-bit
			} else {
				this.operand1.write(this.operand2.read());
				jemul8.panic("LFS :: Not implemented");
				//cpu.FS.set(accessorRead.readValue(this.operand2.getPointerAddress() + 4, 2));
				// In Protected Mode, load the descriptor into the segment register
			}
		// Load Full Pointer with GS
			...
			if ( this.sizeOperand <= 2 ) {
				...
				//cpu.GS.set(accessorRead.readValue(this.operand2.getPointerAddress() + 2, 2));
				// In Protected Mode, load the descriptor into the segment register
			// 32-bit
			} else {
				this.operand1.write(this.operand2.read());
				jemul8.panic("LGS :: Not implemented");
				//cpu.GS.set(accessorRead.readValue(this.operand2.getPointerAddress() + 4, 2));
				// In Protected Mode, load the descriptor into the segment register
			}
		// Load Full Pointer with SS
			...
			if ( this.sizeOperand <= 2 ) {
				...
				//cpu.SS.set(accessorRead.readValue(this.operand2.getPointerAddress() + 2, 2));
				// In Protected Mode, load the descriptor into the segment register
			// 32-bit
			} else {
				this.operand1.write(this.operand2.read());
				jemul8.panic("LSS :: Not implemented");
				//cpu.SS.set(accessorRead.readValue(this.operand2.getPointerAddress() + 4, 2));
				// In Protected Mode, load the descriptor into the segment register
			}
