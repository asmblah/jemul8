...
.module("cpu/instruction/stack", function ( $ ) { "use strict";
	...
	jemul8.x86CPU.prototype.pushStack = function ( val, len ) {//debugger;
		/* ==== Malloc ==== */
		...
		bitmaskSize = jemul8.generateMask(len);
	...
	jemul8.x86CPU.prototype.popStack = function ( len ) {
		...
		//res = this.accessorRead.readValue((this.SS.get() << 4) + ptrStack, len);
