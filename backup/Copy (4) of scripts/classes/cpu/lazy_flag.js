...
.module("emulator", function ( $ ) {
	...
	function LazyFlag( name, regMaster, bitsInLeft ) {
		/* ==== Guards ==== */
		jemul8.Assert(this != self, "LazyFlag constructor :: not called as constructor.");
		jemul8.Assert(regMaster && regMaster instanceof jemul8.LazyFlagRegister, "LazyFlag constructor :: no valid master LazyFlagRegister specified.");
		/* ==== /Guards ==== */
