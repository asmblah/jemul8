...
.module("memory", function ( $ ) { "use strict";
	...
	var PHY_MEM_WIDTH = 32
		...
		, MEM_HANDLERS = jemul8.shr(jemul8.shl(1, PHY_MEM_WIDTH), 20)
	...
	Memory.prototype.init = function () {
		...
		this.bufDRAM = jemul8.allocBuffer(sizeBytes);
	...
	= function ( addrBegin, addrEnd, fnRead, fnWrite, arg ) {
		...
		var idx, idxStart = jemul8.shr(addrBegin, 20)
			, idxEnd = jemul8.shr(addrEnd, 20);
