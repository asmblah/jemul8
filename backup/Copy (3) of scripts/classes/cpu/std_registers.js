...
var mod = new jsEmu.PrimaryModule( function ( jsEmu ) {
	...
	jsEmu.x86CPU.prototype.InstallStandardRegisters = function () {
		...
		var UnlazyFlag = jsEmu.UnlazyFlag;
		/* ==== /Malloc ==== */
		...
		// Unknown(1) Flag
		this.UF1 = this.hsh_reg["UF1"] = new UnlazyFlag( "UF1", this.EFLAGS, 1 );
		// Parity Flag
		this.PF = this.hsh_reg["PF"] = new LazyFlag( "PF", this.EFLAGS, 2 );
		// Unknown(2) Flag
		this.UF2 = this.hsh_reg["UF2"] = new UnlazyFlag( "UF2", this.EFLAGS, 3 );
		// Auxiliary Flag
		this.AF = this.hsh_reg["AF"] = new LazyFlag( "AF", this.EFLAGS, 4 );
		// Unknown(3) Flag
		this.UF3 = this.hsh_reg["UF3"] = new UnlazyFlag( "UF3", this.EFLAGS, 5 );
		// Zero Flag
		...
		// Unknown(4) Flag
		this.UF4 = this.hsh_reg["UF4"] = new UnlazyFlag( "UF4", this.EFLAGS, 15 );
		// Resume Flag
