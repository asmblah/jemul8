...
.module("cpu/lazy_flags_register", function ( $ ) { "use strict";
	...
	function LazyFlagRegister( name, sizeBytes ) {
		/* ==== Guards ==== */
		$.assert(this && (this instanceof LazyFlagRegister)
	...
	LazyFlagRegister.prototype.install = function ( component ) {
		...
		case x86Emu.LazyFlag:	// Fall through
		case x86Emu.UnlazyFlag:
			component.cpu = this.cpu;
			this.cpu[ component.name ] = component;
			this.hsh_flg[ component.name ] = component;
			break;
		default:
			$.problem("x86CPU.install :: Provided component cannot be installed into the CPU.");
		}
	};
	...
	// Exports
	x86Emu.LazyFlagRegister = LazyFlagRegister;
});
