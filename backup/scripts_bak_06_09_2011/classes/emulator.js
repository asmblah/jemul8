...
.module("emulator", function ( $ ) { "use strict";
	...
	function x86Emu() {
		...
		// Emulated IBM-compatible PC
		this.machine = machine = new x86Emu.PC( this );
		// The memory subsystem
		machine.mem = new x86Emu.Memory( machine );
		// The I/O subsystem
		machine.io = new x86Emu.IO( machine );
		...
		machine.vga = new x86Emu.VGA( machine ); // Video card
	...
	// Pause the emulator
	x86Emu.prototype.pause = function () {
		$.panic("x86Emu.pause() :: Unimplemented");
	};
