    ...
    describe("CPU 'movs' instruction", function () {
        ...
        util.each([
            ...
            },
            {
                ...
                from: 0x280008,
                to: 0x290008,
                expectedSI: 0x280008 + 6,
                expectedDI: 0x290008 + 6
            },
            {
                operandSize: 32,
                addressSize: 32,
                ...
                from: 0x280002,
                to: 0x290002,
                expectedSI: 0x280002 + 8,
                expectedDI: 0x290002 + 8
            }
        ], function (scenario) {
            ...
            describe(description, function () {
                util.each({
                    "the #REP prefix": prefix + "rep movs" + suffix,
                    "the LOOP instruction": "start:\n" + prefix + "movs" + suffix + "\n loop start"
                }, function (command, method) {
                    describe("when using " + method + " to repeat while (E)CX > 0", function () {
                        beforeEach(function (done) {
...
hlt
EOS
*/) {}, {command: command, register32: register32, quantums: scenario.quantums, from: scenario.from, to: scenario.to});
