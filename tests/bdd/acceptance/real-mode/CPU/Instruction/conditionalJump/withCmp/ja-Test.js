...
define([
    ...
    describe("CPU 'ja' (jump if above, unsigned) instruction", function () {
        var system,
            testSystem;
        ...
        describe("when under 16-bit real mode", function () {
            it("should jump when the left operand was greater", function (done) {
...
*/) {});
            ...
            it("should not jump when the left operand was smaller", function (done) {
                var assembly = util.heredoc(function (/*<<<EOS
org 0x100
