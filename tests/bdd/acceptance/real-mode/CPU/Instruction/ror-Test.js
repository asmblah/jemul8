...
define([
    ...
    describe("CPU 'ror' (rotate right) instruction", function () {
        ...
        util.each({
            "10111010b >> 0 = 10111010b": {
                ...
                registers: {
                    ...
                    of: 1  // Set OF to ensure it is unaffected (zero rotate)
                },
                expectedRegisters: {
                    bl: parseInt("10111010", 2),
