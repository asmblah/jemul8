...
define([
    ...
    Execute.functions = {
        ...
        // UNsigned Multiply
            ...
            var res = (multiplicand * multiplier);
        ...
        // - See http://faydoc.tripod.com/cpu/xlat.htm
            ...
            var addrVirtual = (RBX.get() + cpu.AL.get()) & RBX.mask;
