...
define([
	...
	x86CPU.prototype.install = function ( component ) {
		...
		case Pin:
			...
			break;
		default:
			util.panic("x86CPU.install :: Provided component cannot be"
	...
	x86CPU.prototype.flushInstructionCaches = function () {
	...
	x86CPU.prototype.interrupt = function ( vector, type, pushError, errorCode ) {
    ...
    x86CPU.prototype.realModeInterrupt = function ( vector, pushError, errorCode ) {
        var IDTR = this.IDTR;
	...
	x86CPU.prototype.getCPL = function () {
